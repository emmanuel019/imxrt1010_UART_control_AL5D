...
#ifndef _MIMXRT1011_FEATURES_H_
#define _MIMXRT1011_FEATURES_H_
...
#define FSL_FEATURE_SOC_AIPSTZ_COUNT (2)
...
#define FSL_FEATURE_ADC_SUPPORT_ALTCLK_REMOVE (0)
...
#define FSL_FEATURE_INTERRUPT_IRQ_MAX (79)
...
#define FSL_FEATURE_SRC_HAS_SRSR_LOCKUP (1)
/* @brief There is LOCKUP_SYSRESETREQ bit in SRSR register. */
#define FSL_FEATURE_SRC_HAS_SRSR_LOCKUP_SYSRESETREQ (0)
